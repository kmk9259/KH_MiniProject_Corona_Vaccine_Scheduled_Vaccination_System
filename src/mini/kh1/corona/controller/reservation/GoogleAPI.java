...
//			if(location.equals("신촌세브란스병원")) {
				imageURL = "https://maps.googleapis.com/maps/api/staticmap?key=AIzaSyABp_X71PUMpwCoerh_KCDCZ5FqJy3hFns&center="+ URLEncoder.encode(location, "UTF-8")  +  "&zoom=16&size=500x500&scale=2";
